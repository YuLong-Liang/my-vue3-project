...
export default [
  {
    url: '/api/study/time/getTodayTimeRecord',
    method: 'get',
    response: () => {
      return {
        code: '200',
  ...
  {
    url: '/api/study/state/getCurrentProgram',
    method: 'get',
    response: () => {
      return {
        code: '200',
  ...
  {
    url: '/api/study/state/currentProgram',
    method: 'post',
    response: ({ body }) => {
  ...
  {
    url: '/api/study/test/preTest/:seriesid/:programid',
    method: 'get',
    response: ({ query }) => {
      const { seriesid, programid } = query
  ...
  {
    url: '/api/study/audio/mp3/v1/:word',
    method: 'get',
    rawResponse: (req, res) => {
      const { word } = req.params || {} // 从URL参数中获取word
      try {
        // 读取音频文件
  ...
  {
    url: '/api/study/time/saveTimeRecord',
    method: 'post',
  ...
  {
    url: '/api/study/word/getWordsAndState',
    method: 'post',
    response: ({ headers, body }) => {
      console.log(headers['authorization'])
      const {
  ...
  {
    url: '/api/study/state/currentUnit',
    method: 'post',
    response: ({ headers, body }) => {
      console.log(headers)
      const {
  ...
  {
    url: '/api/study/history/getHistoryWordById',
    method: 'get',
    response: ({ query }) => {
      console.log(query)
  ...
  {
    url: '/api/study/word/record/saveRecord',
    method: 'post',
    response: ({ body }) => {
      console.log(body)
      const {
  ...
  {
    url: '/api/study/word/record/updateRecord',
    method: 'post',
    response: ({ body }) => {
      console.log(body)
      const {
  ...
  {
    url: '/api/study/test/isPreTest/:seriesid/:programid',
    method: 'get',
    response: ({ params }) => {
      console.log(params)
  ...
  {
    url: '/api/study/state/restudyProgram',
    method: 'post',
    response: ({ body }) => {
      console.log(body)
      const {
