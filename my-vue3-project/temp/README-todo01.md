...
智能听写、智能默写三个
  src\views\dcyx\learn-main\inteli-dictataion.vue
  src\views\dcyx\learn-main\inteli-writing.vue

二、智能听写（Intelligent Dictation）页面功能列表
功能定位：

通过听单词发音，用户进行拼写练习，强化词义和拼写记忆。记录拼写正确率和学习时长。
...
计时器显示
播放发音图标（扬声器）
三、智能默写（Intelligent Writing）页面功能列表
功能定位：

针对单词的默写练习，用户根据单词释义或上下文进行拼写练习，帮助加深记忆和书写能力。
